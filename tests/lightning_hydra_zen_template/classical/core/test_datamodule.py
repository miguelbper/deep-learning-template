...
# Global variables for test data dimensions
...
# Create global numpy arrays for testing
...
class CompleteDataModule(DataModule):
    """DataModule with all required methods implemented."""
...
class IncompleteDataModule(DataModule):
    """DataModule with missing method implementations."""
...
def test_complete_datamodule():
    """Test that a complete DataModule implementation works properly."""
...
def test_incomplete_datamodule():
    """Test that an incomplete DataModule implementation raises TypeError."""
    with pytest.raises(TypeError):
        # Should raise TypeError when instantiating abstract class with
        # abstract methods
        IncompleteDataModule()


def test_cannot_instantiate_base_datamodule():
    """Test that base DataModule class cannot be instantiated directly."""
    with pytest.raises(TypeError):
        DataModule()
