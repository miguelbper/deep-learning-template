...
from lightning_hydra_zen_template.deep.configs import EvalCfg, TrainCfg
from lightning_hydra_zen_template.deep.eval import evaluate
from lightning_hydra_zen_template.deep.train import train
...
class TestEval:
    ...
    def test_main(self, ckpt_path: str) -> None:
        eval_script = find_root() / "src" / "lightning_hydra_zen_template" / "deep" / "eval.py"
